...
const AppContextProvider = ({ children }) => {
  ...
  const fetchSavings = async (userId) => {
    setLoading(true);
    try {
      const response = await axios.get(`http://localhost:3000/api/v1/savings/${userId}`);
  ...
  const analysis = async (user_id, Month) => {
    setLoading(true);
    try {
      const response = await axios.get(`http://localhost:3000/api/v1/getpercentage/${user_id}?month=${Month}`);
  ...
  const getallgoals = async (userd) => {
    setLoading(true);
    try {
      const response = await axios.get(`http://localhost:3000/api/v1/all_goals/${userd}`);
  ...
  const fetchTransactions = async (user_id, Month, Category) => {
    setLoading(true);
    try {
      const response = await axios.get(`http://localhost:3000/api/v1/readtransaction?user=${user_id}&month=${Month}&category=${Category}`);
  ...
  const createUser = async (username, email, password) => {
    setLoading(true);
    try {
      const response = await axios.post('http://localhost:3000/api/v1/createUser', {
  ...
  const getAllUsers = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get('http://localhost:3000/api/v1/readuser');
  ...
  const getUserById = async (userId) => {
    ...
    setError(null);
    try {
      const response = await axios.get(`http://localhost:3000/api/v1/readSingleUser/${userId}`);
      setUser(response.data);
      setLoading(false);
      return response.data;
    } catch (error) {
  ...
  const updateUserById = async (userId, userData) => {
    ...
    setError(null);
    try {
      const response = await axios.put(`http://localhost:3000/api/v1/updateUser/${userId}`, userData);
      setLoading(false);
      return response.data;
    } catch (error) {
      setLoading(false);
  ...
  const creategoal = async (userId, goalData) => {
    setLoading(true);
    try {
      const response = await axios.post('http://localhost:3000/api/v1/creategoal', {
        userId, ...goalData
      });
      setLoading(false);
  ...
  const creatransaction = async (userId, formData) => {
    setLoading(true);
    try {
      const response = await axios.post('http://localhost:3000/api/v1/createtransaction', {
        user: userId,
        ...formData
      });
      setLoading(false);
