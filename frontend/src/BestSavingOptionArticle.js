...
const BestInvestmentArticle = () => {
  return (
    <div style={styles.fullScreenContainer}>
      <div style={styles.articleContainer}>
        <h1 style={styles.title}>Best Investment Plans</h1>
        <p style={styles.paragraph}>
          The best investment plans are tailored to individual financial goals, risk tolerance, and time horizon. Here are some strategies to consider:
        </p>
        ...
        <div style={styles.section}>
          ...
          <ul style={styles.list}>
            <li style={styles.listItem}><strong>50% in Nifty Fifty Companies:</strong> Maintain stability with established large-cap companies.</li>
            <li style={styles.listItem}><strong>20% in Mid-Level Index Companies:</strong> Invest in mid-cap companies for balanced growth potential.</li>
            <li style={styles.listItem}><strong>10% in Small Index Companies:</strong> Allocate to small-cap companies with higher growth potential.</li>
            <li style={styles.listItem}><strong>10% in Fixed Deposits:</strong> Secure a portion of your capital with fixed deposits for stable returns.</li>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.paragraph}>
            Nifty Fifty companies offer a stable foundation due to their established market presence and consistent performance, providing stability in a diversified portfolio.
          </p>
        </div>
        ...
        <div style={styles.section}>
          <h2 style={styles.subtitle}>Importance of Fixed Deposits</h2>
          <p style={styles.paragraph}>
            Fixed deposits offer a secure way to earn stable returns, making them a reliable component in a balanced investment portfolio.
          </p>
        </div>
...
export default BestInvestmentArticle;
